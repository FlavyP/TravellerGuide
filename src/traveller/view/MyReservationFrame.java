...
public class MyReservationFrame extends JDialog implements TravellerView {
	...
	public static MyReservationFrame getInstance(Window owner,
		...
		if (instance == null) {
			instance = new MyReservationFrame(owner, actionListener,
					focusListener);
	...
	public void createComponents() {
		tableLabels = new String[] { "Id", "Hotel", "CheckIn", "CheckOut",
				"sRooms", "dRooms", "tRooms", "Apartments", "totalPrice" };
